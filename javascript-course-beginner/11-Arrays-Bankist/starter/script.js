...
const buah = ['jeruk', 'apel', 'mangga', 'pisang', 'pepaya'];
// slice tanpa mengubah array asli
const favorite = buah.slice(1, 3);
console.log(favorite);
console.log(buah);
// splice mengubah array asli
const hapusBuah = buah.splice(1, 3);
...
const calcAverageHumanAge = function (ages) {
  ...
  console.log(adults);
  const average = adults.reduce((acc, age, i, arr) => acc + age / arr.legth, 0); // 2 3. (2+3)/2 = 2.5 === 2/2+3/2 = 2.5
...
console.log(convertTitleCase('and here is another title with many words'));
